    ...
    public partial class FormNguoiThue : Form
    {
        ...
        public void TaiPhong()
        {
            ...
            if (ph != null)
            {
                ...
                txtSoNThue.Text = ph.NguoiThues.Count.ToString();
                lblMSPhong.Show();
                lblDiaChi.Show();
                lblDienTich.Show();
                lblTienThue.Show();
        ...
        private void tsbtnTTCaNhan_Click(object sender, EventArgs e)
        {
            ...
            frmTTCaNhan.ShowDialog(); frmTTCaNhan.ShowDialog();
            Show();
        }
        ...
        {
            if (ngThue.PhongTroe.NguoiThues.Count > 1)
            {
